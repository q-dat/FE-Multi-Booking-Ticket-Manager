...
import {
  IPayment,
  PaymentStatus
} from '../../../../types/type/payment/payment';
...
const ModalEditPaymentPageAdmin: React.FC<ModalEditPaymentPageAdminProps> = ({
  isOpen,
  onClose,
  paymentId
}) => {
  const { getPaymentById, updatePaymentStatus, payments } =
