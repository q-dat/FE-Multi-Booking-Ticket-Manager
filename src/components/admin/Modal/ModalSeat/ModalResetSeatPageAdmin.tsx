...
const ModalResetSeatPageAdmin: React.FC<ModalResetSeatProps> = ({
  isOpen,
  onClose,
  onConfirm
}) => {
      ...
      >
        <div>
          <p className="font-bold text-black dark:text-white">
            Bạn có chắc chắn muốn "reset" trạng thái
        ...
        <div className="w-[300px] py-5 text-center text-gray-50">
          Khi bạn nhấn
          <label className="font-bold text-primary"> "Xác Nhận" </label>, trạng
          thái của tất cả ghế sẽ được đặt lại.
        </div>
