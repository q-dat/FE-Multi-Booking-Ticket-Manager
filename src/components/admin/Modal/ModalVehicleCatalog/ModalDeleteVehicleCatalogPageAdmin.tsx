...
const ModalDeleteVehicleCatalogPageAdmin: React.FC<ModalDeleteAdminProps> = ({
  isOpen,
  onClose,
  onConfirm
}) => {
      ...
      >
        <div className="">
          <p className="font-bold text-black dark:text-white">
            Loại phương tiện này sẽ bị xoá!
...
export default ModalDeleteVehicleCatalogPageAdmin;
