...
<div className="grid grid-cols-1 gap-4 md:grid-cols-3 p-5">
  {tickets.map((ticket: ITicket) => (
    <div
      key={ticket._id}
      className="flex-none transform overflow-hidden rounded-lg bg-white text-black shadow-md shadow-primary transition-transform duration-300 ease-in-out hover:scale-105"
    >
