      ...
      <div className="my-5">
        ...
        <div className="my-5 grid w-full grid-cols-2 items-center justify-center gap-5">
          {filteredTickets.map((ticket: ITicket) => (
            <div
              key={ticket._id}
              className="w-full transform rounded-lg dark:hover:bg-gray-50 bg-white text-black shadow-md shadow-primary transition-transform duration-300 ease-in-out hover:bg-primary hover:bg-opacity-10"
            >
